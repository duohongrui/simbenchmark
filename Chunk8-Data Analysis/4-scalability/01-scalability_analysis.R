...
saveRDS(scalability_data, file = "./Chunk8-Data Analysis/4-scalability/scalability_data.rds")
### scalability score


#### Filter NAs in cell_num and gene_num (TedSim method)
...
saveRDS(score_data, file = "Chunk8-Data Analysis/4-scalability/score_data.rds")
...
saveRDS(score_data, file = "./Chunk8-Data Analysis/4-scalability/scalability_plot_data.rds")
