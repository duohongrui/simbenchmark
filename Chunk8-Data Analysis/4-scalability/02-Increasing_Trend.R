...
saveRDS(scalability_gene_model, file = "Chunk8-Data Analysis/4-scalability/scalability_gene_model.rds")
saveRDS(scalability_cell_model, file = "Chunk8-Data Analysis/4-scalability/scalability_cell_model.rds")
