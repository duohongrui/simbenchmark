...
saveRDS(trajectory_data, file = "Chunk8-Data Analysis/3-functionality/trajectory_data.rds")
### turn to long table
trajectory_long_data <- trajectory_data %>% 
  pivot_longer(., cols = 3:ncol(.), names_to = "metric", values_to = "value")
saveRDS(trajectory_long_data, file = "Chunk8-Data Analysis/3-functionality/trajectory_long_data.rds")
