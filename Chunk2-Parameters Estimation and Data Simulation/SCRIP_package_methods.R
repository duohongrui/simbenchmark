#------------------------------------------------------------------------------#
# This file contains five simulation methods:
# 1. SCRIP(GP-trendedBCV)  2. SCRIP(GP-commonBCV)  3. SCRIP(BGP-commonBCV)
# 4. SCRIP(BP)  5. SCRIP(BGP-trendedBCV)
#------------------------------------------------------------------------------#
library(simpipe)
library(dplyr)
library(stringr)
...
for(i in 1:length(data_list)){
  ...
  for(method in methods){
    ## data save file
    save_name <- paste0("SCRIP-", method, "_", data_id)
    message(save_name)
